...
namespace torch {
  namespace data {
    namespace datasets {
      ...
      class CIFAR100 : public DS::Dataset<CIFAR100>
      {
        private:
          torch::Tensor Images;
        ...
        public:
          ...
          // Loads the CIFAR100 dataset from the `root` path.
          //
          // The supplied `root` path should contain the *content* of the unzipped
          // CIFAR100 dataset, available from
          // https://www.cs.toronto.edu/~kriz/cifar.html
          // https://www.cs.toronto.edu/~kriz/cifar-10-binary.tar.gz
          explicit CIFAR100(const std::string &root, Mode mode = Mode::kTrain);
          ...
          /// Returns true if this is the training subset of CIFAR100.
